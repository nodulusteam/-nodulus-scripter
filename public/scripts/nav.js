...
.directive("scripterNav", function ($compile, $mdDialog, $IDE) {
    return {
        ...
        controller: function ($scope, $resource, $Language) {
            ...
            $scope.subTreeResource = $resource('@nodulus/scripter/navigation/', {});
            ...
            $scope.AddNew  = function () {
                $IDE.ShowLobby({ "_id": "scripter", "label": "scripter" }, "@nodulus/scripter/modules.html");
            }
        },
        templateUrl: "@nodulus/scripter/nav.html",
